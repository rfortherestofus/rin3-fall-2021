...
You can watch everyone's feedback here: https://rfortherestofus.com/r-in-3-months-feedback-fall-2021/

<!-- Note to David: If you make me an admin for the repo for the URL shortner I could make a short URL for this. -->
...
1. Set yourself up to connect to be able to connect to GitHub

--

1. Post your project as a GitHub repository (aka "repo")

--

1. Post the URL to your repository in the thread
